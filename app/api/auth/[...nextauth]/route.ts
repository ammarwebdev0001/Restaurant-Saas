...
export const authConfig = {
  ...
  callbacks: {
    ...
    async jwt(params: any) {
      ...
      // Credentials sign-in: `user` contains id/email/role returned from authorize().
      if (user) {
        const u = user as any;
      ...
      // Ensure we always have id/role for the session.
  ...
  // In dev this falls back to an internal secret; in production you should set NEXTAUTH_SECRET.
  secret:
