/*
  ...
  - Added the required column `updatedAt` to the `OnSaleProduct` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `updatedAt` to the `ShopData` table without a default value. This is not possible if the table is not empty.
...
*/
-- AlterTable
ALTER TABLE "OnSaleProduct" ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- AlterTable
ALTER TABLE "ShopData" ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL;
